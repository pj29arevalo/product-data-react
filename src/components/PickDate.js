    ...
    <section className="bg-white dark:bg-dark">
      <div className="container px-0">
        <div className="mx-auto max-w-[380px] relative" ref={datepickerRef}>
          ...
          {isOpen && (
            <div className="shadow-xs absolute w-full z-10 flex flex-col rounded-lg border border-stroke bg-white px-4 py-6 sm:px-6 sm:py-[30px] dark:border-dark-3 dark:!bg-dark-2">
